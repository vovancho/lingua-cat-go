...
func (ecu exerciseCompleteUseCase) GetItemsByUserID(ctx context.Context, userId auth.UserID) ([]domain.ExerciseComplete, error) {
	...
	ecuList, err := ecu.exerciseCompleteRepo.GetItemsByUserID(ctx, userId)
	if err != nil {
